class Admin::ModelsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @model.save
        format.html { redirect_to admin_model_url(@model), notice: "Model was successfully created." }
  ...
  def update
    respond_to do |format|
      if @model.update(model_params)
        format.html { redirect_to admin_model_url(@model), notice: "Model was successfully updated." }
